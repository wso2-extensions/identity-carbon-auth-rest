                    ...
                    try {
                        ...
                        if (userRealm != null) {
                            ...
                            if (isAuthenticated) {
                                ...
                                true in the thread local. It will be used in TOTPService.
                                This approach can be improved by providing a Level of Assurance (LOA) and checking
                                that in TOTPService.
                                 */
                                if (authenticationRequest.getRequest() != null && authenticationRequest.getRequest()
                                        .getRequestURI().toLowerCase().endsWith(TOTP_ENDPOINT_URI)) {
