...
('up2hxlkj-654n-1ujd-5wnf-uvhs3ppwf9j8', 'corsOrigins', 'A resource type to keep the tenant CORS Origins'),
('u14hxlkj-654n-hpld-5wnf-uv8j3p8wc2j8', 'corsConfiguration', 'A resource type to keep the tenant CORS configurations');
