...
/**
 * Simple service to test REST authorization.
 */
@Component(name = "HelloService",
        service = { Microservice.class },
        immediate = true)
@SuppressWarnings("unused")
@Path("/simple-rest/test")
...
//        log.debug("Simple REST hello service activated.");
    }

    @Deactivate
    protected void deactivate() {
//        log.debug("Simple REST hello service deactivated.");
    }
